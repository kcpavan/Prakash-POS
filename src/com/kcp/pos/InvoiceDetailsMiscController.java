 ...
 * @author pbhimanna
 */
public class InvoiceDetailsMiscController implements Initializable {
    ...
    @FXML
    private TableColumn<InvoiceDetailsDo, Double> itemMarginCol;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        itemMarginCol.setCellValueFactory(
                new PropertyValueFactory<InvoiceDetailsDo, Double>("margin"));
